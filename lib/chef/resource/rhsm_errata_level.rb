...
class Chef
  class Resource
    class RhsmErrataLevel < Chef::Resource
      ...
      description "The rhsm_errata_level resource will install all packages for all"\
                  " errata of a certain security level. For example, you can ensure"\
      ...
      property :errata_level,
               ...
               description: "The errata level of packages to install. Accepts: critical, moderate, important, or low.",
               name_property: true
